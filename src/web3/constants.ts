...
export const signerPrivateKey = requiredEnv(
  'SIGNER_PRIVATE_KEY',
) as `0x${string}`;
...
export const nodeFeeVault = requiredEnv(
  'NODE_FEE_VAULT_ADDRESS',
) as `0x${string}`;
export const vipFeeVault = requiredEnv(
  'VIP_FEE_VAULT_ADDRESS',
) as `0x${string}`;
